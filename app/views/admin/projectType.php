<h4 class="fw-bold py-3">Project type</h4>
        ...
        <tbody class="table-border-bottom-0">
            <?php if (is_array($projectTypes)): ?>
                <?php foreach($projectTypes as $projectType): ?>
                    <tr>
                        <td><i class="fab fa-angular fa-lg text-danger"></i> <strong><?=$projectType['id']?></strong></td>
                        <td><?=$projectType['name']?></td>
                        <td style=" max-width: 620px; white-space: normal; word-wrap: break-word;"><?=$projectType['description']?></td>
                        <td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h4 class="modal-title text-success">ADD PROJECT TYPE</h4>
            </div>
            <form action="<?=_WEB_ROOT?>/add-project-type" method="POST">
...
<div class="modal fade text-left" id="updateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h4 class="modal-title text-primary">EDIT PROJECT TYPE</h4>
            </div>
            <form action="<?=_WEB_ROOT?>/update-project-type" method="POST">
...
<div class="modal fade text-left" id="deleteModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h4 class="modal-title text-danger">DELETE PROJECT TYPE</h4>
            </div>
            <div class="modal-body">
                <p class="text-center">Do you want to delete this PROJECT type?</p>
            </div>
            <form action="<?=_WEB_ROOT?>/delete-project-type" method="POST">
